...
$stmt = $conn->prepare("INSERT INTO formgen (proj_title,prop_inst,prop_state,dir_title,dir_lname,dir_fname,dir_street,dir_pcode,dir_city,dir_phone,dir_fax,
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $pm_tu_id = isset($_POST['pm_tu_id']) ? $_POST['pm_tu_id'] : "0";
    ...
    $res1_tu_id = isset($_POST['res1_tu_id']) ? $_POST['res1_tu_id'] : "0";
    ...
    $res2_tu_id = isset($_POST['res2_tu_id']) ? $_POST['res2_tu_id'] : "0";
...
//Binding all 97 parameters
    if (!$stmt->bind_param("ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssiiiiiiiiiiissssssssiiis", $proj_title, $prop_inst, $prop_state, $dir_title,
        $dir_lname, $dir_fname, $dir_street, $dir_pcode, $dir_city, $dir_phone, $dir_fax,
        $pi_title, $pi_lname, $pi_fname, $pi_street, $pi_pcode, $pi_city, $pi_phone, $pi_fax, $pm_title, $pm_lname, $pm_fname, $pm_street,
